...
namespace EgitimPlatformu.Models.Database
{
    ...
    public partial class EgitimPlatformEntities : DbContext
    {
        public EgitimPlatformEntities()
            : base("name=EgitimPlatformEntities")
        {
        }
        ...
        public virtual DbSet<FirmaBankaBilgileri> FirmaBankaBilgileri { get; set; }
        ...
        public virtual DbSet<PermissionKategori> PermissionKategori { get; set; }
